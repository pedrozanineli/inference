...
def set_calc(model_name):
        ...
        for file in tqdm(range(len(files))):
                ...
                for struc_index,structure in enumerate(structures):
                        ...
                        with open(f'{path}/predicted_energies.pkl','ab') as f: pickle.dump(predicted_energies,f)
                        with open(f'{path}/predicted_forces.pkl','ab') as f: pickle.dump(predicted_forces,f)
                        with open(f'{path}/dft_forces.pkl','ab') as f: pickle.dump(real_forces,f)
                        with open(f'{path}/dft_energies.pkl','ab') as f: pickle.dump(real_energies,f)
